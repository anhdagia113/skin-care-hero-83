...
public class HomeService {
    ...
    private Map<String, String> getIntroduction() {
        ...
        intro.put("description",
                "Your trusted partner for professional skincare services. Our expert therapists provide personalized treatments to help you achieve your best skin ever.");
        return intro;
    }
    ...
    public Map<String, Object> getPaymentPolicy() {
        ...
        policy.put("cancellationPolicy",
                "Free cancellation up to 24 hours before appointment. Late cancellations incur a 50% fee.");
